...
const APP_SHELL = [
  ...
  './js/components/onboarding.js?v=30',
  ...
  './js/components/welcomeScreen.js?v=41',
  './js/services/ocr.js?v=34',
  ...
  './js/services/scheduleParser.js?v=34',
  './js/services/tasks.js',
  './js/utils/html.js',
  './js/utils/animations.js',
  './js/utils/time.js',
  './js/views/home.js?v=38',
  './js/views/importSchedule.js?v=38',
  './js/views/schedule.js?v=43',
